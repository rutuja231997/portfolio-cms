...
function About({ pageInfo }: Props) {
  return (
    <motion.div
      ...
      className="flex flex-col relative min-h-screen text-center md:text-left lg:flex-row max-w-7xl px-6 md:px-10 justify-evenly lg:space-x-20 mx-auto items-center"
    >
      ...
      <motion.img
        ...
        className="mt-10 xl:mt-0 md:mb-0 shrink-0 w-48 h-48 rounded-full object-cover md:rounded-full md:w-50 md:h-50 lg:w-62.5 lg:h-62.5 "
      />
